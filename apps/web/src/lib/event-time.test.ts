...
import { formatShortTime, formatPopularMeta, formatWeekdayMonthDay, deriveEventTimeStatus, isLiveNow } from "./event-time";
...
describe("event-time", () => {
  ...
  it("formats list when-line dates as weekday, month day", () => {
    expect(formatWeekdayMonthDay("2026-08-02T11:00:00.000-07:00")).toBe("Sunday, Aug 2");
  });
